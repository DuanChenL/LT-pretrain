...
from .coco_ssl import SSLCocoDataset


@DATASETS.register_module()
class SSLLVISV05Dataset(SSLCocoDataset):
    ...
    def prepare_train_img(self, idx):
        ...
        # x = results.copy()
        # results = self.base_pipeline(results)
        # x = results.copy()
        # results_1 = self.last_pipline(results)
        # results_2 = self.sim_pipline(x)
        # results_2 = self.last_pipline(results_2)
...
SSLLVISDataset = SSLLVISV05Dataset
DATASETS.register_module(name='SSLLVISDataset', module=SSLLVISDataset)


@DATASETS.register_module()
class SSLLVISV1Dataset(SSLLVISDataset):
