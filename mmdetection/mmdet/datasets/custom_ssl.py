...
class SSLCustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        sim_pipline = [
            ...
            # dict(type='Grayscaling', prob=0.5),
            # dict(type='ColorTransform', level=4, prob=0.2),
            # dict(type='BrightnessTransform', level=4, prob=0.2),
        ]
        last_pipline = [
        ...
        self.base_pipeline = Compose(base_pipeline)
        self.sim_pipline = Compose(sim_pipline)
        self.last_pipline = Compose(last_pipline)
