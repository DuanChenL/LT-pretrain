...
# optimizer
# optimizer = dict(type='SGD', lr=0.03, momentum=0.9, weight_decay=0.00005)
...
# load_from='/data1/PycharmProjects/dcl/long-tail-detection/baseline/work_dirs/irfs_ssl_mse_0.6/backbone.pth'
